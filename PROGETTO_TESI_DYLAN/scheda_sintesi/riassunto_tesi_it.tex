...
\begin{center}
  ...
  {\small Candidato: Dylan Magliano (s337915) \quad---\quad
   Relatori: prof. Flavio Giobergia, prof. Sergio Caprioli}\\
...
disposizione, ma perfettamente plausibili sul piano statistico, restano
...
Kullback--Leibler e il peso $\beta$ resta fissato a 1: la formulazione
impiegata è quella dell'ELBO canonico.
...
Le misurazioni confermano rigorosamente il teorema di Bourlard e Kamp: PCA e
...
restituiscono esattamente la stessa graduatoria, il che esclude che
l'ordinamento sia un artefatto della sensibilità dell'MSE agli \emph{outlier}.
...
ricostruzione è quindi contenuto, e assai minore di quanto una prima
...
dà la spiegazione: in tutte e tre le configurazioni solo circa sei dimensioni
...
delle correlazioni non è dunque un iperparametro da calibrare, ma una
...
scelta di $K = 20$ come modello definitivo --- il gomito della curva di
ricostruzione --- risulta perciò robusta.
...
produce output privi di coerenza economico-finanziaria. La regolarizzazione
...
L'obiettivo è più specifico: costruire una distribuzione di scenari realistici
della struttura di correlazione \emph{a un orizzonte di un mese a partire
dallo stato di mercato osservato oggi}, da valutare in ottica di rischiosità.
...
cinque criteri}, e tutte le matrici risultano definite positive come garantito
per costruzione dalla parametrizzazione di Cholesky. L'ispezione grafica di
dettaglio su un singolo scenario conferma il quadro anche sugli oggetti che
...
Il mescolamento casuale, pur risolvendo il \emph{distribution shift}, non
...
La tesi ha progettato, implementato e validato un framework completo per la
...
benchmark lineari --- in cambio dell'unica proprietà che rende possibile la
generazione stocastica. La conformità simultanea dei mille scenari generati ai
cinque fatti stilizzati valida l'architettura proposta come strumento autonomo
