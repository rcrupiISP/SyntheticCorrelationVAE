...
Per garantire che le matrici sintetiche generate risultino rigorosamente semidefinite positive (PSD) --- un vincolo algebrico imprescindibile per qualsiasi matrice di correlazione valida --- l'input dei modelli non si basa sulla matrice cruda, bensì sulla sua decomposizione di Cholesky. Attraverso questa parametrizzazione, i modelli apprendono a comprimere e successivamente riprodurre l'intera struttura informativa nel pieno rispetto dei vincoli matematici.
